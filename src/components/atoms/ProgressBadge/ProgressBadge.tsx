...
export const ProgressBadge = ({ percentage }: ProgressBadgeProps) => {
  ...
  return (
    <div className="flex items-center justify-center gap-1 rounded-md border border-neutral-200 px-1 py-0.5 font-semibold text-neutral-600 shadow-sm dark:border-neutral-700 dark:text-white/80">
