...
export const TaskItemCard = ({
  ...
  return (
    <article
      data-id={id}
      className="dark:bg-primary flex w-full flex-col rounded-lg border border-neutral-200 bg-white text-[0.8125rem] dark:border-neutral-700 dark:text-white"
    >
      ...
      <div className="flex w-full items-center justify-between px-3 py-2 text-neutral-600">
